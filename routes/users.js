...
const { constructActivationEmail, constructForgotCredentialsEmail } = require('../helpers/mails');
const { makeRequest, getProFileData } = require('../helpers/dbqueries');
...
router.post('/login', async(req, res) => {
    if(req.body.constructor === Array) return { status: 0, message: 'Invalid format!', code: 404 };
        else return { status: 0, message: 'Goood format!', code: 404 };
